...
class WhereAnswersCategory: AnswersCategory {
    ...
    companion object {
        private val keywords = hashMapOf<Int, List<List<String>>>(0 to listOf(listOf("plan", "zajec", "wykladowcow"), listOf("plan", "zajec")),
        ...
        private val answers = hashMapOf<Int, Int>(0 to R.array.where_answer_0,
