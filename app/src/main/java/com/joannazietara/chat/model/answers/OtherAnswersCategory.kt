...
class OtherAnswersCategory: AnswersCategory {
    ...
    companion object {
        private val keywords = hashMapOf<Int, List<List<String>>>(0 to listOf(listOf("parkowac"), listOf("parking")),
            1 to listOf(listOf("otwarta", "uczelnia"), listOf("otwarcia", "uczelni")),
            2 to listOf(listOf("wynajecia", "sali"), listOf("wynajecie", "sali")),
            3 to listOf(listOf("uczyc", "przerwie"), listOf("pouczyc", "przerwie"), listOf("coworking"), listOf("coworkingu")),
            4 to listOf(listOf("pytanie", "inne")))
        private val answers = hashMapOf<Int, Int>(0 to R.array.other_answer_0,
